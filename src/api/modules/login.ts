import { Login, RegisterForm, Menu, ResultData } from '@/api/interface/index'
 ...
 */
// * 用户register
export const register = (params: RegisterForm.ReqProps) => {
...
export const getAuthMenu = () => {
	return http.get<ResultData<Menu.ResList[]>>(PORT1 + `/getAuthMenu`)
}
